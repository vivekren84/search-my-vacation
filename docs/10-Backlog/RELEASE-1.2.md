...
| Number of Completed Tasks | 53 of 128 | All 19 Workstream 1 tasks, all 13 Workstream 2 tasks, all 13 Workstream 6 tasks (R1.2-06.01–06.13, flipped to Complete on the strength of the Product Owner's Workstream 6 Acceptance — see Section 5), Workstream 5's `R1.2-05.18`–`05.20` (3), `R1.2-07.05`, and four Workstream 4 tasks — `R1.2-04.10` (`EBC-R1.2-WS8-02`) and `R1.2-04.01`/`04.03`/`04.04` (new, `EBC-R1.2-WS4-05` — see Section 16.3) — are Complete — 19+13+13+3+1+4 = 53. |
| Task Status Breakdown | 53 Complete · 1 In Progress · 17 Ready for QA · 57 Proposed (of 128) | Reconciled directly against the six per-workstream Section 6 task tables by `EBC-R1.2-WS8-01` (36/1/17/74), re-reconciled by `EBC-R1.2-WS7-07` after flipping Workstream 6's 13 tasks to Complete (49 Complete; 61 Proposed), re-reconciled by `EBC-R1.2-WS8-02` after flipping `R1.2-04.10` to Complete (50 Complete; 60 Proposed), and re-reconciled again by this update (`EBC-R1.2-WS4-05`) after flipping `R1.2-04.01`/`04.03`/`04.04` to Complete on independently-verified repository evidence (50+3=53 Complete; 60-3=57 Proposed). The previous dashboard figure ("33 Complete · 0 Approved · 95 Proposed") had omitted the "Ready for QA" and "In Progress" categories entirely — corrected at `EBC-R1.2-WS7-07`. |
...
- [x] This document (`RELEASE-1.2.md`) is current at Version 1.20
...
| RISK-R1.2-007 | Active | Tied directly to Workstream 4; cannot close until `04.05` (full entry-path regression) runs |
...
| RISK-R1.2-013 | Active (partially informed) | Workstream 4 remains genuinely disputed/incomplete; this assessment's `04.10` finding (Section 15.2) is new evidence for one task only, not a reconciliation of the workstream as a whole |
