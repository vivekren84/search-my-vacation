...
| Number of Approved Decisions | 14 | DEC-R1.2-001 through DEC-R1.2-014; see Section 7. DEC-R1.2-013 records the R1.2-014 validation review's confirmed outcome; DEC-R1.2-014 records the Destination Operational Steward appointment closing ADR §15 Outstanding Decision 1. |
| Number of EBCs | 20 | R1.2-001 through R1.2-020; see Document Change History. |
| Number of Completed EBCs | 20 | R1.2-001 through R1.2-020 are complete as of this consolidation. |
