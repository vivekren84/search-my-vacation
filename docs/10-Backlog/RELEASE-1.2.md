...
| Number of Completed Tasks | 50 of 128 | All 19 Workstream 1 tasks, all 13 Workstream 2 tasks, all 13 Workstream 6 tasks (R1.2-06.01–06.13, flipped to Complete on the strength of the Product Owner's Workstream 6 Acceptance — see Section 5), Workstream 5's `R1.2-05.18`–`05.20` (3), `R1.2-07.05`, and `R1.2-04.10` (new, `EBC-R1.2-WS8-02` — see Section 15.2) are Complete — 19+13+13+3+1+1 = 50. |
| Task Status Breakdown | 50 Complete · 1 In Progress · 17 Ready for QA · 60 Proposed (of 128) | Reconciled directly against the six per-workstream Section 6 task tables by `EBC-R1.2-WS8-01` (36/1/17/74), re-reconciled by `EBC-R1.2-WS7-07` after flipping Workstream 6's 13 tasks to Complete (49 Complete; 61 Proposed), and re-reconciled again by this update (`EBC-R1.2-WS8-02`) after flipping `R1.2-04.10` to Complete on newly-discovered repository evidence (49+1=50 Complete; 61-1=60 Proposed). The previous dashboard figure ("33 Complete · 0 Approved · 95 Proposed") had omitted the "Ready for QA" and "In Progress" categories entirely — corrected at `EBC-R1.2-WS7-07`. |
...
- [x] This document (`RELEASE-1.2.md`) is current at Version 1.19
