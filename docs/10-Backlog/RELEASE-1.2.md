...
| Number of Completed Tasks | 49 of 128 | All 19 Workstream 1 tasks, all 13 Workstream 2 tasks, all 13 Workstream 6 tasks (R1.2-06.01–06.13, flipped to Complete on the strength of the Product Owner's Workstream 6 Acceptance — see Section 5), Workstream 5's `R1.2-05.18`–`05.20` (3), and `R1.2-07.05` are Complete — 19+13+13+3+1 = 49. |
| Task Status Breakdown | 49 Complete · 1 In Progress · 17 Ready for QA · 61 Proposed (of 128) | Reconciled directly against the six per-workstream Section 6 task tables by `EBC-R1.2-WS8-01` (36/1/17/74) and re-reconciled by this update after flipping Workstream 6's 13 tasks to Complete on Product Owner Acceptance (36+13=49 Complete; 74-13=61 Proposed). The previous dashboard figure ("33 Complete · 0 Approved · 95 Proposed") had omitted the "Ready for QA" and "In Progress" categories entirely — corrected here, not merely updated. |
...
- **Six repository documents still cite fabricated `WS7-IMP-01`–`04`/`WS7-AUD-01`/`WS7-GOV-01`** as completed source cards. None exist. Correcting them is outside this card's scope (`docs/10-Backlog/RELEASE-1.2.md` only) and is recommended as its own dedicated Tiger governance card.
...
**Recommendation:** the same four-item remediation `EBC-R1.2-WS8-01` recommended still stands — run Workstream 8 in full; resolve the Workstream 4 dispute with a dedicated Rad verification pass against commit `0bbac73`; correct the six WS7 citations; and obtain a formal Workstream 5 Product Acceptance once `[SMV-DBG]` removal closes. None of the four requires reopening a completed, validated decision.
...
- [x] This document (`RELEASE-1.2.md`) is current at Version 1.17
